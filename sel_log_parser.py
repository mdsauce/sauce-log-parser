...
def standalone_read_log(log_name, command):  # duplicate?
...
def standalone_generate_results(job_id):  # duplicate?
...
def build_job(job,
    ...
    job_instance.fetch_json_log(args.admin, args.access_key, args.save)
